...
Inheritance access specifiers are used to define the accessibity of the subsequent members of the base class. There are three types of the access specifiers.
